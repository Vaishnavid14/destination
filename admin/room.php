<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM room WHERE room_type LIKE '%".$valueToSearh."%' OR room_price LIKE '%".$valueToSearh."%'";
...
echo "<td>" . $row['sleeps']  . "</td>";
echo "<td>" . $row['available']  . "</td>";
echo "<td>" . $row['hotel_id']  . "</td>";
echo "<td><a href='hotel_edit.php?id=".$row['room_id']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
echo "<td><a href='hotel_delete.php?id=".$row['room_id']."'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
echo "<td><a href='print.php?id=".$row['room_id']."'><img src='./images/icons8-Print-32.png' alt='Print'></a></td>";
echo "</tr>";
}
echo "</table>";
