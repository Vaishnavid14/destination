<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM hotel WHERE hotel_name LIKE '%".$valueToSearh."%' OR hotel_city LIKE '%".$valueToSearh."%'";
...
echo "<td><img src='images1/" . $row['hotel_image'] . "'style='width:200px;height:100px;'></td>";
echo "<td>" . $row['total_rooms'] . "</td>";
echo "<td>" . $row['hotel_address']  . "</td>";
echo "<td>" . $row['hotel_pincode']  . "</td>";
echo "<td>" . $row['hotel_city']  . "</td>";
echo "<td><a href='hotel_edit.php?id=".$row['hotel_id']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
echo "<td><a href='hotel_delete.php?id=".$row['hotel_id']."'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
echo "<td><a href='print.php?id=".$row['hotel_id']."'><img src='./images/icons8-Print-32.png' alt='Print'></a></td>";
echo "</tr>";
}
echo "</table>";
