...
<form action="register_tour.php" method="POST">
  <div class="container">
	<input type="text" placeholder="Tour Name" name="tourname" required>
    <input type="text" placeholder="Tour Price" name="price" required>
    <input type="text" placeholder="No. of days" name="days" required>
  	<label>Image</label>
    ...
    <input type="text" placeholder="Places separate with ," name="places" required>
    <div class="clearfix">
