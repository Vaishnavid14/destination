...
<form action="tour_update.php" method="POST">
  <div class="container">
  <?php
	$result = mysqli_query($mysqli,"SELECT * FROM tour WHERE tour_id ='$id'");
	while($row = mysqli_fetch_array($result))
	{
	echo"<input type='hidden' name='id' value='{$row['tour_id']}' required>";
    echo"<input type='text' placeholder='Tour Name' name='name' value='{$row['tour_name']}' required>";
    echo"<label>Image</label>";
    echo"<input type='file' name='image' required>";
    echo"<input type='text' placeholder='Tour Price' name='price' value='{$row['tour_price']}' required>";
    echo"<input type='text' placeholder='No. of Days' name='days' value='{$row['tour_no_of_days']}' required>";
    echo"<label><b>Type</b>";
    echo"
    <select name='type'>
    ...
    echo"</label>";
    echo"<input type='text' placeholder='Ticket per km' name='place' value='{$row['tour_places']}' required>";
