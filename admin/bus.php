<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM bus_list WHERE bus_no LIKE '%".$valueToSearh."%' OR bus_type LIKE '%".$valueToSearh."%'";
...
echo "<td>" . $row['ticket_per_km']  . "</td>";
echo "<td><a href='bus_edit.php?id=".$row['bus_id']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
echo "<td><a href='delete_bus.php?id=".$row['bus_id']."'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
echo "<td><a href='print.php?id=".$row['bus_id']."'><img src='./images/icons8-Print-32.png' alt='Print'></a></td>";
echo "</tr>";
}
echo "</table>";
