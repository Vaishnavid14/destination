...
<h2>Tour</h2>
<hr/>
<form action="register_tour.php" method="POST">
  <div class="container">
	<input type="text" placeholder="Bus No." name="busnum" required>
    <input type="text" placeholder="Total Seats" name="seat" required>
    <label>Type</label>
    <select name="type">
    ...
    <input type="text" placeholder="Ticket Per km ," name="ticket" required>
    <div class="clearfix">
